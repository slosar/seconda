...
export DOCKER_ENV="-e ARES -e HOME -e PYTHONPATH -e LD_LIBRARY_PATH -e LUSEE_DRIVE_DIR -e LM_LICENSE_FILE -v /home/anze:/home/anze -v /tmp/.X11-unix:/tmp/.X11-unix --user $(id -u):$(id -g)"
